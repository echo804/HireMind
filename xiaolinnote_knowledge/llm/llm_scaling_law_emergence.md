...
<code class="language-">loss(N) ≈ (N_c / N)^α_N</code>
...
<table><thead><tr><th>模型</th><th>参数</th><th>数据</th><th>训练算力</th><th>最终效果</th></tr></thead><tbody><tr><td>Gopher（DeepMind 自家旧版）</td><td>280B</td><td>300B tokens</td><td>X</td><td>基线</td></tr><tr><td>GPT-3</td><td>175B</td><td>300B tokens</td><td>0.7X</td><td>比 Gopher 略弱</td></tr><tr><td>**Chinchilla**（按 1:20 配比）</td><td>**70B**</td><td>**1.4T tokens**</td><td>X</td><td>**明显超过 Gopher 和 GPT-3**</td></tr></tbody></table>
...
<code class="language-">GPT-3: 175B 参数 / 300B tokens = 1 : 1.7
最优比例: 1 : 20
GPT-3 数据缺口: 12 倍</code>
...
<code class="language-">Llama 3 8B: 8B 参数 / 15T tokens = 1 : 1875
（Chinchilla 推荐: 1 : 20）</code>
