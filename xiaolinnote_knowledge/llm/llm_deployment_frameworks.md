...
把上面几个框架放一起对比：
<table><thead><tr><th>框架</th><th>核心创新</th><th>最佳场景</th><th>性能</th><th>生态</th></tr></thead><tbody><tr><td>**vLLM**</td><td>PagedAttention + Continuous Batching</td><td>高吞吐 LLM API</td><td>极高</td><td>开源活跃</td></tr><tr><td>**SGLang**</td><td>RadixAttention（共享前缀）</td><td>Agent / 多轮 / Few-shot</td><td>极高（特定场景超 vLLM）</td><td>较新但快速增长</td></tr><tr><td>**TGI**</td><td>HF 生态集成</td><td>企业级 + HF 生态</td><td>高</td><td>HF 全家桶</td></tr><tr><td>**llama.cpp**</td><td>C++ 重写 + GGUF</td><td>CPU / Mac / 边缘</td><td>CPU 上极强</td><td>个人 / 边缘</td></tr><tr><td>**TensorRT-LLM**</td><td>NVIDIA 硬件极致优化</td><td>大厂 NVIDIA 集群</td><td>极高（特定硬件上很强）</td><td>NVIDIA 官方开源</td></tr></tbody></table>
