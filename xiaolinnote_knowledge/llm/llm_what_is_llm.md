...
<table><thead><tr><th>维度</th><th>传统 NLP</th><th>LLM</th></tr></thead><tbody><tr><td>任务方式</td><td>一任务一模型，pipeline 串联</td><td>一个模型干所有事，Prompt 统一接口</td></tr><tr><td>输出范式</td><td>判别式（输出标签/概率）</td><td>生成式（输出文本）</td></tr><tr><td>能力来源</td><td>显式监督训练（喂什么学什么）</td><td>大规模预训练 + 涌现（学到没教过的能力）</td></tr></tbody></table>
