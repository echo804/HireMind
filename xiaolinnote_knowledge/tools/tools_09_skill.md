...
<code class="language-">code-review/                  # Skill 文件夹，名字就是这个 Skill 的标识
├── SKILL.md                  # 核心指令文件（必须有）
├── scripts/                  # 可选：可执行的脚本
...
└── assets/                   # 可选：模板、资源文件
    └── report_template.md    # 比如审查报告的输出模板</code>
...
### 第三步：输出报告
使用 assets/report_template.md 的模板格式，输出结构化的审查报告。</code>
