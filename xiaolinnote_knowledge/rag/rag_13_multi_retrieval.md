...
把三种召回方式的特点对比一下，方便选型：
<table><thead><tr><th>召回方式</th><th>擅长</th><th>短板</th><th>适合场景</th></tr></thead><tbody><tr><td>向量检索</td><td>语义相似、同义词、不同表达</td><td>精确词语、数字、专有名词</td><td>通用语义检索</td></tr><tr><td>BM25 关键词</td><td>精确词匹配、专有名词</td><td>同义词、语义相关但词不重叠</td><td>有大量精确词语的知识库</td></tr><tr><td>多 Query 扩展</td><td>覆盖不同表述角度</td><td>增加 LLM 调用开销</td><td>用户提问风格多变的场景</td></tr></tbody></table>## 🎯 面试总结
